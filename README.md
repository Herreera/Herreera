...
[![My Skills](https://skillicons.dev/icons?i=py,linux,ubuntu,git,github,gitlab,docker,aws,react,mongodb,mysql,redhat,js,html,css,tailwind,threejs,discord,discordjs,htmx)](https://herreradev.xyz)
